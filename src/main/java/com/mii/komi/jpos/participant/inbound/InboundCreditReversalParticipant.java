...
import com.mii.komi.dto.inbound.CreditReversalRequest;
import com.mii.komi.dto.inbound.CreditReversalResponse;
...
public class InboundCreditReversalParticipant extends GenericInboundParticipantImpl {

    public static String CREDIT_REVERSAL_PC = "209100";
    ...
    public ISOMsg buildRequestMsg(long id, Serializable context) {
        try {
            ...
            CreditReversalRequest debitRequest = ctx.get(Constants.HTTP_REQUEST);
            ...
            ISOMsg isoMsg = ISO8583Service.buildFinancialMsg(CREDIT_REVERSAL_PC, debitRequest);
    ...
    public ResponseEntity buildSpesificRspBody(long id, Serializable context) {
        ...
        CreditReversalRequest request = (CreditReversalRequest) ctx.get(Constants.HTTP_REQUEST);
        CreditReversalResponse rsp = new CreditReversalResponse();
