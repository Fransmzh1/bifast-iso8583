 ...
 * @author vinch
 */
public class InboundDebitReversalParticipant extends GenericInboundParticipantImpl {
    ...
    public ISOMsg buildRequestMsg(long id, Serializable context) {
        try {
            ...
            DebitReversalInboundRequest debitRequest = (DebitReversalInboundRequest) ctx.get(Constants.HTTP_REQUEST);
            ...
            ISOMsg isoMsg = ISO8583Service.buildFinancialMsg(DEBIT_REVERSAL_TRANSFER_PC, debitRequest);
    ...
    public ResponseEntity buildSpesificRspBody(long id, Serializable context) {
        ...
        DebitReversalInboundRequest request = (DebitReversalInboundRequest) ctx.get(Constants.HTTP_REQUEST);
